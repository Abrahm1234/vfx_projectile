...
@export_range(0.0, 10.0, 0.01) var emiss_energy_rings: float = 2.5
...
@export_range(0.001, 0.2, 0.001) var ring_thickness: float = 0.008
@export_range(0.0, 1.0, 0.001) var ring_pulse_amount: float = 0.08
@export_range(0.0, 20.0, 0.01) var ring_pulse_speed: float = 4.0

# Sparks ring orbit (Godot 4.5: orbit_velocity is Vector2(min,max))
@export_range(0.0, 20.0, 0.01) var spark_orbit_min: float = 2.2
@export_range(0.0, 20.0, 0.01) var spark_orbit_max: float = 2.2
@export_range(0.0, 1.0, 0.01) var spark_orbit_random: float = 0.4
